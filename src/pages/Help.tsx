          ...
          <li className="mb-3">
            <div className="flex items-center gap-2">
              <svg
                ...
                height="16"
                fill="currentColor"
                className="bi bi-telephone-fill fill-light-accent dark:fill-dark-primary"
                viewBox="0 0 16 16"
              >
                <path
                  fillRule="evenodd"
          ...
          <li className="mb-3">
            <div className="flex items-center gap-2">
              <svg
                ...
                height="16"
                fill="currentColor"
                className="bi bi-envelope-at-fill fill-light-accent dark:fill-dark-primary"
                viewBox="0 0 16 16"
              >
          ...
          <li className="mb-3">
            <div className="flex items-center gap-2">
              <svg
                ...
                height="16"
                fill="currentColor"
                className="bi bi-calendar-day-fill fill-light-accent  dark:fill-dark-primary"
                viewBox="0 0 16 16"
              >
                ...
                <li className="mb-3">
                  <div className="flex items-center gap-2">
                    <svg
                      ...
                      height="16"
                      fill="currentColor"
                      className="bi bi-question-circle-fill fill-light-accent dark:fill-dark-primary"
                      viewBox="0 0 16 16"
                    >
                ...
                <li className="mb-3">
                  <div className="flex items-center gap-2">
                    <svg
                      ...
                      height="16"
                      fill="currentColor"
                      className="bi bi-pen stroke-light-accent dark:stroke-dark-primary"
                      viewBox="0 0 16 16"
                    >
              ...
              <li className="mb-3">
                <div className="flex items-center gap-2">
                  <svg
                    ...
                    height="16"
                    fill="currentColor"
                    className="bi bi-hand-index-thumb stroke-light-accent  dark:stroke-dark-primary"
                    viewBox="0 0 16 16"
                  >

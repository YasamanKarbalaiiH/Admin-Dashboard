    ...
    <div className="lg:p-6 lg:w-[60%] w-full mx-auto pt-6 pr-3 pl-4 text-sm lg:text-md  ">
      <div className="flex items-center">
        <svg
          ...
          height="24"
          fill="currentColor"
          className="bi bi-sliders2 fill-dark-border mb-6 mr-3 text-3xl font-bold"
          viewBox="0 0 16 16"
        >
          <path
            fillRule="evenodd"
        ...
        <h1 className="text-3xl  font-bold mb-8 text-dark-bg dark:text-white">
          Settings
        </h1>
      </div>

      <div className="bg-light-surface dark:bg-dark-surface p-6 rounded-lg shadow-md">
        <h2 className="text-xl font-bold mb-6 text-dark-bg dark:text-white">
          Profile Settings
        </h2>
          ...
          <div>
            <div className="mb-4 flex ">
              ...
              <svg
                ...
                height="16"
                fill="currentColor"
                className="bi bi-pencil-square ml-3 fill-dark-border dark:fill-white"
                viewBox="0 0 16 16"
            ...
            <label className="block text-sm font-medium mb-1 text-dark-bg dark:text-white">
              Full Name
            </label>
            <input
              type="text"
      ...
      <div className="bg-light-surface dark:bg-dark-surface p-6 rounded-lg shadow-md mt-6">
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between text-dark-bg dark:text-white">
      ...
      <div className="bg-light-surface dark:bg-dark-surface p-6 rounded-lg shadow-md mt-6">
        ...
        <div className="space-y-3">
          <button className="w-full text-left px-4 py-3 bg-light-bg dark:bg-dark-bg text-dark-bg dark:text-white rounded-lg hover:bg-light-accent dark:hover:bg-dark-border transition flex items-center gap-3 border border-light-accent dark:border-dark-border">
            <span>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
                fill="currentColor"
                className="bi bi-key-fill fill-dark-border dark:fill-white"
                viewBox="0 0 16 16"
              >
          ...
          <button className="w-full text-left px-4 py-3 bg-light-bg dark:bg-dark-bg text-dark-bg dark:text-white rounded-lg hover:bg-light-accent dark:hover:bg-dark-border transition flex items-center gap-3 border border-light-accent dark:border-dark-border">
            <span>
              <svg
                ...
                height="16"
                fill="currentColor"
                className="bi bi-phone fill-dark-border dark:fill-white"
                viewBox="0 0 16 16"
              >
